...
$APPLICATION->SetPageProperty("title", "Бренды и производители – Rusmarta");
$APPLICATION->SetPageProperty("description", "Все производители товаров каталога компании. Сигнализация и видеооборудование, системы видеонаблюдения с доставкой по всей России в интернет-магазине Rusmarta.ru");

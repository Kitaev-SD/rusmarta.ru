...
use Bitrix\Main\Localization\Loc;?><div id="geolocationDelivery-<?=$arParams['ELEMENT_ID']?>" class="geolocation-delivery" data-element-id="<?=$arParams['ELEMENT_ID']?>" data-element-count="<?=$arParams['ELEMENT_COUNT']?>" data-cart-products="<?=$arParams['CART_PRODUCTS']?>" data-cache-type="<?=$arParams['CACHE_TYPE']?>" data-cache-time="<?=$arParams['CACHE_TIME']?>">

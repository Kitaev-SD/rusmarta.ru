...
$tagsCount = count( $arResult['UF_SECTION_TAG'] );
if($tagsCount >= 1){	
    ?>
        ...
        <div class="catalog-section">		
            <div class="catalog-section-childs bottom-tags show-more-subcategories">
                <?for ($i = 0; $i < $tagsCount; $i++): 
                    if($arResult['UF_SECTION_LINK'][$i]=='') continue;?>
                
                    <div class="bottom-tag">
                        <a rel="nofollow" href="<?php echo $arResult['UF_SECTION_LINK'][$i] ? $arResult['UF_SECTION_LINK'][$i] : '' ?>" title="<?=$arResult['UF_SECTION_TAG'][$i]?>">
                            <span class="child">
                                <span class="text-cont">
                                    <span class="text"><?=$arResult['UF_SECTION_TAG'][$i]?></span>
                                </span>
                            </span>
                        </a>
                    </div>

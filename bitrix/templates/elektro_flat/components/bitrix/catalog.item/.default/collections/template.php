...
<div class="catalog-item-info">							
	...
	<div class="item-image-cont">
		<div class="item-image">								
			...
			<a rel="nofollow" href="<?=$arElement['DETAIL_PAGE_URL']?>"<?=(is_array($arElement["PREVIEW_PICTURE"])) ? " style='background-image:url(".$arElement['PREVIEW_PICTURE']['SRC'].")'" : " style='background-image:url(".SITE_TEMPLATE_PATH."/images/no-photo.jpg)'"?>></a>
			<span class="sticker">
				<?=$sticker?>
			</span>

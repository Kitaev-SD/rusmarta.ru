		...
		<?foreach($arResult["ITEMS"] as $arItem):?>			
			<a class="news-block__item" href="<?=$arItem["DETAIL_PAGE_URL"]?>">
				<span class="news-block__item-block">
					<span class="data-lazy-background news-block__item-image"<?=($arItem["PREVIEW_PICTURE"]["SRC"] ? " data-lazy-background=\"background-image:url('".$arItem["PREVIEW_PICTURE"]["SRC"]."');\"" : "");?>></span>
				</span>
				<span class="news-block__item-block">

          ...
          <span class="child">
						<span class="graph">
                            ...
                            <? } elseif (is_array($arItem["PICTURE"])) { ?>
                                <img class="data-lazy-src" data-lazy-src="<?= $arItem['PICTURE']['SRC'] ?>" width="<?= $arItem['PICTURE']['WIDTH'] ?>"
                                     height="<?= $arItem['PICTURE']['HEIGHT'] ?>" alt="<?= $arItem['TEXT'] ?>"
                                     title="<?= $arItem['TEXT'] ?>"/>
                            <? } else { ?>
                                <img class="data-lazy-src" data-lazy-src="<?= SITE_TEMPLATE_PATH ?>/images/no-photo.jpg" width="50" height="50"

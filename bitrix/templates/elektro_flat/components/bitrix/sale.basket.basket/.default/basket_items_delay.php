						...
						<div class="tr_into">
							...
							<?if(in_array("DELAY", $arParams["COLUMNS_LIST"])):?>
								<div class="cart-item-actions">
									<div class="in-order">
										<a onclick="yaCounter22745254.reachGoal('aside'); return true;" class="setaside" href="<?=str_replace("#ID#", $arBasketItems["ID"], $arUrlTempl["add"])?>" title="<?=GetMessage("SALE_ADD_CART")?>"><i class="fa fa-shopping-cart"></i></a>
									</div>

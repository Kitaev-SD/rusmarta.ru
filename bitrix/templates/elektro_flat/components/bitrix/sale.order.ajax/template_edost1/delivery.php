...
<?						} else if (!isset($v['office_detailed']) || $v['office_detailed'] !== '') { ?>
						<a class="edost_link" href="<?=(!empty($v['office_detailed']) ? $v['office_detailed'] : 'http://edost.ru/office.php?c='.$v['office_id'])?>" target="_blank"><?=$v['office_link']?></a>
<?						} ?>
					</div>
<?					} ?>

			...
			if ($arSetting["CATALOG_LOCATION"]["VALUE"] == "HEADER") : ?>
				...
				<header>
					...
					<div class="modal_no_cookie modal_no_cookie_first">
						...
						Ïðåäóïðåæäåíèå Äëÿ ñîâåðøåíèÿ ïîêóïîê ïîæàëóéñòà, <a href="https://yandex.ru/support/common/browsers-settings/browsers-cookies.html" target="_blank">ðàçðåøèòå ïðèíèìàòü cookie</a> â ñâîåì áðàóçåðå
					</div>
				</header>

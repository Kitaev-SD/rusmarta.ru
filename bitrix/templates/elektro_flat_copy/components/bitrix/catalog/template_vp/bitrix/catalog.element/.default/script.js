						...
						BX.ajax.post(
							...
							BX.delegate(function(result)
							{
								this.setContent(result);
							 	...
							 	//MATCH PHONE TO REGEXP===================
                                var regExpString = '[+]7 [(][0-9]{3}[)] [0-9]{3}-[0-9]{4}';

                                var regExpPatter = new RegExp(regExpString, 'g');


                                var inputPhone = $('#'+this.uniquePopupId + ' input[name="PHONE"');
                                inputPhone.focusout(function() {

                                    if( inputPhone.val().match(regExpPatter) == null ){
                                        inputPhone.addClass('v-error');
                                    }else{
                                        inputPhone.removeClass('v-error');
                                    }
                                });

...
<form action="<?=$this->__component->__path?>/script.php" id="<?=$arResult['ELEMENT_AREA_ID']?>_form" enctype="multipart/form-data">
	...
	<?}?>
	<div class="submit 123">
		<button type="button" id="<?=$arResult['ELEMENT_AREA_ID']?>_btn"  onclick="ym(22745254,'reachGoal','boc_posted'); ga('send', 'event', 'byoneclick', 'posted');" class="btn_buy popdef"><?=Loc::getMessage("FORMS_SEND")?></button>
	</div>
</form>

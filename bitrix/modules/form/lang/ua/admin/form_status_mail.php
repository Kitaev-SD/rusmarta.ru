<?
$MESS["FORM_CHANGE_STATUS_S"] = "#SERVER_NAME#: Статус заявки №#RS_RESULT_ID# змінено на [#RS_STATUS_NAME#] (#RS_FORM_NAME#)";
...
$MESS["FORM_L_EMAIL_TO"] = "Адреса одержувача";
...
$MESS["FORM_CHANGE_STATUS_B"] = "Добридень, #RS_USER_NAME#!

Статус заявки №#RS_RESULT_ID# змінено на [#RS_STATUS_NAME#] (#RS_FORM_NAME#)

#SERVER_NAME#
-------------------------------------------------------
Лист згенеровано автоматично.
";
$MESS["FORM_L_STATUS_ID"] = "Ідентифікатор статуса результату";
$MESS["FORM_L_NAME"] = "Ім'я форми";
$MESS["FORM_L_STATUS_NAME"] = "Найменування статусу результату";
...
$MESS["FORM_CHANGE_STATUS"] = "Зміна статусу результату форми #FORM_SID# на \"#STATUS_NAME#\"";

...
$arOptions["main"][] = array("use_font_display", GetMessage($MODULE_NAME . "_USE_FONT_DISPLAY"), "N", array("checkbox"));
$arOptions["main"][] = array("del_open_sans", GetMessage($MODULE_NAME . "_DELETE_OPEN_SANS"), "N", array("checkbox"));

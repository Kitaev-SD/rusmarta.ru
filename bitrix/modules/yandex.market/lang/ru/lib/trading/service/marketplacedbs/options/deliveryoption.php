...
$MESS['YANDEX_MARKET_TRADING_SERVICE_MARKETPLACEDBS_OPTIONS_DELIVERYOPTION_SUMMARY'] = '#TYPE# &laquo;#ID#&raquo;, за #DAYS#';
...
<p>На&nbsp;каждый день можно создать до&nbsp;5&nbsp;интервалов. Минимальная продолжительность&nbsp;&mdash; 2&nbsp;часа, максимальная&nbsp;&mdash; 8&nbsp;часов.</p>
<p>Если интервалы не&nbsp;соответствуют требованиям, будет выполнено автоматическое распределение. Например: интервал от&nbsp;10:00 до&nbsp;20:00 будет представлен в&nbsp;виде двух интервалов 10:00-15:00 и 15:00-20:00.</p>
';
...
$MESS['YANDEX_MARKET_TRADING_SERVICE_MARKETPLACEDBS_OPTIONS_DELIVERYOPTION_INCREASE_PERIOD_ON_WEEKEND'] = 'Увеличивать срок доставки на&nbsp;количество выходных';
$MESS['YANDEX_MARKET_TRADING_SERVICE_MARKETPLACEDBS_OPTIONS_DELIVERYOPTION_INCREASE_PERIOD_ON_WEEKEND_HELP'] = 'Необходимо использовать, если служба доставки возвращает срок доставки без учета выходных дней';

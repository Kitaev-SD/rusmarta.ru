...
$MESS['YANDEX_MARKET_TRADING_SERVICE_MARKETPLACE_CANCEL_REASON_PICKUP_EXPIRED'] = 'Покупатель не забрал заказ, в итоге истек срок хранения заказа в пункте выдачи';
$MESS['YANDEX_MARKET_TRADING_SERVICE_MARKETPLACE_CANCEL_REASON_USER_UNREACHABLE'] = 'Не удается дозвониться до покупателя';
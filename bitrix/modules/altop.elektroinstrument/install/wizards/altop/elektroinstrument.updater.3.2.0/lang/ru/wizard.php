...
$MESS["WIZARD_STEP_0_DESCR"] = "Мастер в автоматическом режиме производит следующие операции:<br />1. Обновляет мастер создания сайта «Интернет-магазин электроинструмента ЭЛЕКТРОСИЛА» до последней версии 3.2.0;<br />2. Создает свойства, необходимые для корректной работы сайта";

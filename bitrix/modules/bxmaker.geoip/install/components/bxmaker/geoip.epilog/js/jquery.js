...
!function (a, b) {
    ...
    r.fn = r.prototype = {
        ...
        expando: "jQueryBXmaker" + (q + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (a) {
            throw new Error(a)
        }, noop: function () {
    ...
    r.Deferred.exceptionHook = function (b, c) {
        a.console && a.console.warn && b && P.test(b.name) && a.console.warn("jQueryBXmaker.Deferred exception: " + b.message, b.stack, c)
    ...
    r.event = {
        ...
        constructor: r.Event, isDefaultPrevented: ua, isPropagationStopped: ua, isImmediatePropagationStopped: ua, isSimulated: !1, preventDefault: function () {
    ...
    var Tb = a.jQueryBXmaker, Ub = a.$bxm;
    return r.noConflict = function (b) {
        return a.$bxm === r && (a.$bxm = Ub), b && a.jQueryBXmaker === r && (a.jQueryBXmaker = Tb), r
    }, b || (a.jQueryBXmaker = a.$bxm = r), r
});

<?
$MESS["ACRIT_EXP_RUNNOW_START"] = "Запустить выгрузку";
...
$MESS["ACRIT_CRM_TAB_SYNC_MAN_TITLE"] = "Выгрузить заказы, созданные";
$MESS["ACRIT_CRM_TAB_SYNC_MAN_ALL"] = "За всё время";
$MESS["ACRIT_CRM_TAB_SYNC_MAN_3M"] = "За последние три месяца";
$MESS["ACRIT_CRM_TAB_SYNC_MAN_1M"] = "За последний месяц";
$MESS["ACRIT_CRM_TAB_SYNC_MAN_1W"] = "За последние 7 дней";
$MESS["ACRIT_CRM_TAB_SYNC_MAN_1D"] = "За последние сутки";
$MESS["ACRIT_CRM_TAB_SYNC_MAN_ONLY_NEW"] = "Выгружать только ещё не выгруженные в CRM заказы";

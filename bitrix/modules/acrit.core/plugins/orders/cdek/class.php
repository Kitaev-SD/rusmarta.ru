...
class CdekMarket extends Plugin {
	const ACCOUNT_ID = 'EMscd6r9JnFiQ3bLoyjJY6eM78JrJceI';
	const SECRET_KEY = 'PjLZkKBHEiLK3YsjtNrt3TGNG0ahs3kG';
	const SERVER_URL = 'https://api.edu.cdek.ru/v2/';
	...
	public function getTokenLink() {
		$link = "https://oauth.aliexpress.com/authorize?response_type=code&client_id=".self::ACCOUNT_ID."&state=&view=web&sp=ae";
		return $link;
	}
		...
		<table class="acrit-exp-plugin-settings" style="width:100%;">
			...
			<tr>
				<td width="40%" class="adm-detail-content-cell-l">
					...
					<?=Loc::getMessage('ACRIT_ORDERS_PLUGIN_ALI_SETTINGS_TOKEN');?>:
				</td>

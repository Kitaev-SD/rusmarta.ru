...
<div data-role="ozon_description_stocks">
	<h2>Выгрузка остатков</h2>
	<p>Выгрузка остатков в настоящее время работает в экспериментальном (тестовом) режиме.</p>
	...
	<p>В ближайшее время планируется выпуск функционала выгрузки одновременно на несколько складов.</p>
</div>
...
<ul>
	<li>
		<a href="https://seller.ozon.ru/main?helpCenter=create-issue" target="_blank">

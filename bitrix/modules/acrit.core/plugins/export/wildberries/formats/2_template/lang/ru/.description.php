...
<p>Плагин позволяет выгрузить спецификацию на товары на основе выбранного шаблона.</p>
<p>Общая <strong>схема настройки профиля</strong>:</p>
<ol>
	<li>Создайте профиль (или используйте уже существующий, подходящий к данной товарной категории) и укажите в нём токен подключения к API.</li>
	<li>Выберите подходящий шаблон спецификации. Если вы обновляете уже существующую спецификацию, выберите также и её из списка.</li>
	<li>После сохранения, во вкладке "Настройка инфоблоков / Поля товаров" появятся поля, которые нужно заполнить. Также, во вкладке "Общие настройки" появится список вариантов для поля "Идентификатор товара в заказе WB" - выберите подходящий вариант (как правило, это артикул).</li>
	<li>Поля, одинаковые для всех товаров спецификации можно задать постоянными значениями (для получения готовых вариантов значений, нужно перевести профиль в режим с загрузкой словарей).</li>

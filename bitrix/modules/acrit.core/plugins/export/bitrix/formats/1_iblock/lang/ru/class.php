...
$MESS[$strMessPrefix.'NAME'] = '1С-Битрикс (инфоблоки)';

// Headers
$MESS[$strMessPrefix.'HEADER_GENERAL'] = 'Общие данные';

# Steps
$MESS[$strMessPrefix.'STEP_EXPORT'] = 'Экспорт на портал';
...
# Fields
$MESS[$strMessPrefix.'GET_FIELDS_SECTION_NAME'] = 'Название категории';
?>

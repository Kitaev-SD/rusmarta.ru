...
$MESS[$strMessPrefix.'FIELD_CATEGORY_NAME'] = 'Категория товара';
	$MESS[$strMessPrefix.'FIELD_CATEGORY_DESC'] = 'Категория товара — строка «Водный транспорт»';
	$MESS[$strMessPrefix.'FIELD_CATEGORY_DEFAULT'] = 'Водный транспорт';
...
$MESS[$strMessPrefix.'FIELD_VEHICLE_TYPE_NAME'] = 'Вид техники';
	$MESS[$strMessPrefix.'FIELD_VEHICLE_TYPE_DESC'] = 'Вид техники — одно из значений списка:
<ul>
	<li>Вёсельные лодки</li>
	<li>Гидроциклы</li>
	<li>Катера и яхты</li>
	<li>Каяки и каноэ</li>
	<li>Моторные лодки</li>
	<li>Надувные лодки</li>
</ul>';

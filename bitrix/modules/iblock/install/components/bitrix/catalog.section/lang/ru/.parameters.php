...
$MESS["CP_BCS_USE_COMPARE_LIST"] = "Для добавления к сравнению использовать текущую страницу";
...
$MESS["USE_COMPARE_LIST"] = "Параметр необходимо включать, когда компонент используется отдельно и на той же странице расположен компонент Список сравниваемых товаров (catalog.compare.list)";

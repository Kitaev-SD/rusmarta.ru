...
<tr class="heading">
    <td colspan="2"><?=GetMessage( "ACRIT_GOOGLEMERCHANT_FAQ_BASE" )?></td>
</tr>
<tr>
...
<tr class="heading">
    <td colspan="2"><?=GetMessage( "ACRIT_GOOGLEMERCHANT_INSTRUCTION_BASE" )?></td>
</tr>
<tr>
    <td colspan="2" align="center">
...
<tr>
    ...
    <td valign="top" class="adm-detail-content-cell-r"><textarea cols="60" rows="6" name="ticket_text_proxy"
        ...
        <textarea style="display:none" name="ticket_text_log" id="ticket_text_log">
            <b><?=GetMessage( "ACRIT_GOOGLEMERCHANT_LOG_STATISTICK" )?></b><br/>
            <b><?=GetMessage( "ACRIT_GOOGLEMERCHANT_LOG_ALL" )?></b><br/>
            <?=GetMessage( "ACRIT_GOOGLEMERCHANT_LOG_ALL_IB" )?> <?=$arProfile["LOG"]["IBLOCK"]?><br/>
            <?=GetMessage( "ACRIT_GOOGLEMERCHANT_LOG_ALL_SECTION" )?> <?=$arProfile["LOG"]["SECTIONS"]?><br/>
            <?=GetMessage( "ACRIT_GOOGLEMERCHANT_LOG_ALL_OFFERS" )?> <?=$arProfile["LOG"]["PRODUCTS"]?><br/>
            <b><?=GetMessage( "ACRIT_GOOGLEMERCHANT_LOG_EXPORT" )?></b><br/>
            <?=GetMessage( "ACRIT_GOOGLEMERCHANT_LOG_OFFERS_EXPORT" )?> <?=$arProfile["LOG"]["PRODUCTS_EXPORT"]?><br/>
            <b><?=GetMessage( "ACRIT_GOOGLEMERCHANT_LOG_ERROR" )?></b><br/>
            <?=GetMessage( "ACRIT_GOOGLEMERCHANT_LOG_ERR_OFFERS" )?> <?=$arProfile["LOG"]["PRODUCTS_ERROR"]?><br/>
            <?if( file_exists( $_SERVER["DOCUMENT_ROOT"].$arProfile["LOG"]["FILE"] ) ):?>
                <?=GetMessage( "ACRIT_GOOGLEMERCHANT_LOG_FILE" )?> <?=$arProfile["LOG"]["FILE"]?><br/>
            <?endif?>
        </textarea>
    </td>
</tr>
...
<tr>
	<td colspan="2">
		<?=GetMessage( "ACRIT_GOOGLEMERCHANT_RECOMMENDS" );?>
	</td>
</tr>
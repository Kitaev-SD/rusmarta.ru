...
class CGooglemerchantProfileDB{
    ...
    private $profileTableName = "acrit_googlemerchant_profile";
    private $dataTableName = "acrit_googlemerchant_profile_data";
    private $toolsTableName = "acrit_googlemerchant_profile_tools";

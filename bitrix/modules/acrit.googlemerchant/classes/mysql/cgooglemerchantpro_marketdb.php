...
class CGooglemerchantMarketDB{
    private $tableName = "acrit_googlemerchant_market";
    ...
    public function GetMarketList( $marketId ){
        ...
        if( $dbResult && ( $arItem = $dbResult->Fetch() ) ){
            ...
            array_walk( $arMarketCategory, "CAcritGooglemerchantStringProcess::AcritArrayTrimFunc" );
        }

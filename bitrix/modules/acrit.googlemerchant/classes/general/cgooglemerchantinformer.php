...
class CGooglemerchantInformer{
    ...
    private function GetMarketModulesInfo(){
        ...
        if( CAcritGooglemerchantTools::ArrayValidate( $arModuleList["MODULE"] ) ){
    ...
    public function GetModuleUpdatesInfo(){
        ...
        if( CAcritGooglemerchantTools::ArrayValidate( $arModuleList["MODULE"] ) ){
            foreach( $arModuleList["MODULE"] as $arModule ){
                ...
                if( CAcritGooglemerchantTools::ArrayValidate( $arModule["#"] )
                    && CAcritGooglemerchantTools::ArrayValidate( $arModule["#"]["VERSION"] )
                ){
                    $bHasUpdates = true;
                }
            }

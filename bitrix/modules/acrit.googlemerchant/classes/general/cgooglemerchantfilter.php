...
class CAcritGooglemerchantCatalog extends CAcritCatalogCondCtrlIBlockFields{
    ...
    public static function GetControls( $strControlID = false ){
        $arControlList = array(
            "CondGooglemerchantSetContains" => array(
                "ID" => "CondGooglemerchantSetContains",
                "FIELD" => "SET_CONTAINS",
                "FIELD_TYPE" => "int",
                "MULTIPLE" => "N",
                "GROUP" => "N",
                ...
                "JS_VALUE" => array(
                    ...
                    "popup_params" => array(
                        "lang" => LANGUAGE_ID,
                        "IBLOCK_ID" => CAcritGooglemerchantProps::$arIBlockFilter[0],
                        "discount" => "Y"
                    ),
                    "param_id" => "n"
                ),
            ),
            "CondGooglemerchantAvailability" => array(
                "ID" => "CondGooglemerchantAvailability",
...
class CAcritGooglemerchantPrices extends CAcritCatalogCondCtrlIBlockFields{
	public static function GetClassName(){
		return __CLASS__;
	}
...
class CAcritGooglemerchantProps extends CAcritCatalogCondCtrlIBlockProps{
...
class CAcritGooglemerchantCatalogCond extends CAcritGlobalCondTree{
	public static function GetClassName(){
		return __CLASS__;
	}
	...
	public function OnConditionControlBuildList(){
        if( !$this->boolError && !isset( $this->arControlList ) ){
            ...
            $basicEvents = array_merge( $basicEvents, array(
                    array(
                        "TO_CLASS" => "CAcritGooglemerchantPrices",
                        "TO_METHOD" => "GetControlDescr"
                    ),
                    array(
                        "TO_CLASS" => "CAcritGooglemerchantCatalog",
                        "TO_METHOD" => "GetControlDescr"
                    ),
                )
            );
            foreach( $basicEvents as $arEvent ){
                if( $arEvent["TO_CLASS"] == "CAcritCatalogCondCtrlIBlockProps" ){
                    $arEvent["TO_CLASS"] = "CAcritGooglemerchantProps";
                    $arEvent["TO_MODULE_ID"] = "acrit.googlemerchant";
                    $arEvent["TO_NAME"] = "CAcritGooglemerchantProps::GetControlDescr (acrit.googlemerchant)";
                }

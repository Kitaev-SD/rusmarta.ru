...
// Old core
$MESS["ACRIT_GOOGLEMERCHANT_OP_PHP_PATH"] = "Путь к php:";
...
$MESS["ACRIT_GOOGLEMERCHANT_RECOMMENDS"] = "
...
$MESS["ACRIT_GOOGLEMERCHANT_MARKET_CATEGORIES_UPDATE_BUTTON"] = "Обновить категории выгрузки относительно Торговых порталов";
$MESS["ACRIT_GOOGLEMERCHANT_SET_CRON_AGENTS_OPTIONS_BUTTON"] = "Отключить агенты на хитах";
$MESS["ACRIT_GOOGLEMERCHANT_SET_BITRIX_CLOUD_MONITORING_BUTTON_ON"] = "Включить мониторинг работы модуля";
$MESS["ACRIT_GOOGLEMERCHANT_SET_BITRIX_CLOUD_MONITORING_BUTTON_OFF"] = "Отключить мониторинг работы модуля";
$MESS["SC_SET_CRON_AGENTS_INFO"] = "Пошаговая инструкция запуска агентов на Cron";
$MESS["ACRIT_GOOGLEMERCHANT_SET_CRON_AGENTS_OPTIONS_STEPS"] = "
<ol type=\"1\">

			...
			<?if($productId > 0 && $arParams['CALCULATE_DELIVERY'] !== 'NOT'):?>
				...
				<?ob_start();?>
					<div class="calculate-delivery text-form muted777 muted ncolor<?=($bWithPreview ? ' with_preview' : '')?>">
						...
						<span><span class="animate-load dotted font_sxs" data-event="jqm" data-param-form_id="delivery" data-name="delivery" data-param-product_id="<?=$productId?>"><?=$arParams['EXPRESSION_FOR_CALCULATE_DELIVERY']?></span></span>

...
$MESS["TYPE_BANNERS_TIP"] = "Укажите баннеры какого типа будут выведены на страницу";
...
$MESS["SET_BANNER_TYPE_FROM_THEME_TIP"] = "Cимвольные коды типа баннера и цветовой схемы должны быть одинаковыми, тип баннера будет установлен автоматически";
?>
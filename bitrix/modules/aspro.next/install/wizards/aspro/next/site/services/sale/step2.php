...
if(COption::GetOptionString("aspro.tires2", "wizard_installed", "N", WIZARD_SITE_ID) != "Y")
{
	$locationGroupID = 0;
	$arLocationArr = Array();
...
COption::SetOptionString("aspro.tires2", "wizard_installed", "Y", false, WIZARD_SITE_ID);
?>
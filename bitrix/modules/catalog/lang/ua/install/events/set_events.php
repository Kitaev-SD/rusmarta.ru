<?
$MESS["SMAIL_FOOTER_BR"] = "З повагою, адміністрація";
$MESS["SMAIL_FOOTER_SHOP"] = "Інтернет-магазину";
$MESS["SMAIL_UNSUBSCRIBE"] = "Відписатися";
$MESS["CATALOG_PRODUCT_SUBSCRIBE_LIST_CONFIRM_NAME"] = "Код підтвердження";
$MESS["CATALOG_PRODUCT_SUBSCRIBE_LIST_CONFIRM_DESC"] = "#TOKEN# - Код підтвердження
#TOKEN_URL# - Посилання з кодом підтвердження
#LIST_SUBSCRIBES# - Список підписок
#URL_PARAMETERS# - Параметри посилання для підтвердження коду доступу";
$MESS["CATALOG_PRODUCT_SUBSCRIBE_LIST_CONFIRM_SUBJECT"] = "#SITE_NAME#: Код підтвердження";
$MESS["CATALOG_PRODUCT_SUBSCRIBE_LIST_CONFIRM_HTML_TITLE"] = "Інформаційне повідомлення сайту #SITE_NAME#";
$MESS["CATALOG_PRODUCT_SUBSCRIBE_LIST_CONFIRM_HTML_SUB_TITLE"] = "Шановний, #USER_NAME#!";
$MESS["CATALOG_PRODUCT_SUBSCRIBE_LIST_CONFIRM_HTML_TEXT"] = "Ви отримали це повідомлення, оскільки на вашу адресу був запит кода підтвердження для доступу до підписок сайту #SERVER_NAME#. <br><br> 
Ваш код для підтвердження підписки: #TOKEN# <br><br> 
Для отримання доступу до підписок перейдіть за наступним посиланням: #TOKEN_URL# <br><br>
...
#NAME# - назва товару
#PAGE_URL# - детальна сторінка товару
#CHECKOUT_URL# - додавання товару в корзину
#CHECKOUT_URL_PARAMETERS# - параметри посилання додавання товару в корзину
...
Товар надійшов до нас в магазин, ви можете оформити замовлення прямо зараз: (#CHECKOUT_URL#)<br><br>
Не відповідайте на лист, він сформований автоматично.<br><br>
Дякуємо, що ви з нами!<br>";
$MESS["CATALOG_PRODUCT_SUBSCRIBE_NOTIFY_REPEATED_NAME"] = "Сповіщення про товар в магазині";
$MESS["CATALOG_PRODUCT_SUBSCRIBE_NOTIFY_REPEATED_DESC"] = "#USER_NAME# - ім'я користувача
#EMAIL_TO# - email користувача
#NAME# - назва товару
#PAGE_URL# - детальна сторінка товару
#PRODUCT_ID# - id товару для формування посилань

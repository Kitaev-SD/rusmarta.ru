...
$MESS["DETAIL_URL_TIP"] = "Especifica o endereço da página de visualização detalhada do álbum.";
$MESS["ELEMENTS_LAST_COUNT_TIP"] = "Especifica o número de fotos mais recentes a serem exibidas.";
$MESS["ELEMENTS_LAST_TIME_FROM_TIP"] = "Especifique aqui o primeiro dia do período de seleção.";
$MESS["ELEMENTS_LAST_TIME_TIP"] = "Especifica o número de dias mais recentes durante os quais serão exibidas as fotos.";
...
$MESS["GROUP_PERMISSIONS_TIP"] = "Especifique aqui os grupos de usuários cujos membros podem visualizar o álbum.";
...
";
$MESS["PICTURES_SIGHT_TIP"] = "Selecione aqui os tamanhos iniciais das miniaturas exibidas na página do álbum.";
...
";
$MESS["SET_TITLE_TIP"] = "Ative esta opção para definir o título da página como \"Fotos\".";

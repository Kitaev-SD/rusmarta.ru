...
$MESS['STATWIZ_STEP1_COUNTRY_NOTE_V2'] = "Підтримуються наступні формати:
<ul>
...
$MESS['STATWIZ_STEP2_FILE_TYPE_IPGEOBASE2'] = "Друга частина бази даних блоків IP адрес IpGeoBase. Містить відповідності блоків IP адрес і місцезнаходжень. Повинна бути завантажена після першої частини.";
$MESS['STATWIZ_STEP2_FILE_TYPE_IPGEOBASE2_CITY'] = "Перша частина бази даних блоків IP адрес IpGeoBase. Містить місцезнаходження. Для визначення країни спочатку завантажте індекс країн.";
$MESS['STATWIZ_STEP2_FILE_TYPE_IP_TO_COUNTRY'] = "База даних ip-to-country.";
$MESS['STATWIZ_STEP2_FILE_TYPE_MAXMIND_CITY_LOCATION'] = "Перша частина бази даних GeoIP City або GeoLite City. Містить місцезнаходженя.";
$MESS['STATWIZ_STEP2_FILE_TYPE_MAXMIND_IP_COUNTRY'] = "База даних GeoIP Country або GeoLite Country.";
$MESS['STATWIZ_STEP2_FILE_TYPE_MAXMIND_IP_LOCATION'] = "Друга частина бази даних GeoIP City або GeoLite City. Містить відповідності блоків IP-адрес та місцезнаходжень. Повинна бути завантажена після першої частини.";

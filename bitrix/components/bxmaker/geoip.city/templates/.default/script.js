    ...
    (function () {
        ...
        BXmakerGeoIPCityConstructor.prototype.intval = function (num) {
            if (typeof num == 'number' || typeof num == 'string') {
                ...
                if (dotLocation > 0) {//ùùùùùùùùù ùùùùùùù ùùùùù
            ...
            else if (typeof num == 'object' && num.length != null && num.length > 0) {//ùùùùùùùù ùùùùùù/ùùùùùù -> 1
                return 1;
            }
            else if (typeof num == 'boolean' && num === true) {//true -> 1
                return 1;
            }
            return 0;//ùùùù ùùù ùù ùùù - ùùùùù ù ùùùù
        };
        ...
        BXmakerGeoIPCityConstructor.prototype.initEvent = function () {
            ...
            that.popup.on("click", '.btn_buy.popdef', function () {
                that.popupHide();
            });
        };
                ...
                success: function (r) {
                    if (!!r.response) {
                        ...
                        if (that.params.reload) {
                            ...
                            //ùùùù ùùùù ùùùùù ùùùùùùùùùù ùùùùùù

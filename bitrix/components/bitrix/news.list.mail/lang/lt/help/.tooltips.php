...
$MESS["PREVENT_SEND_IF_NO_NEWS_TIP"] = "Jei nenurodyta, bus pasirinkti tik nauji elementai, kurie buvo pridëti po paskutinio naujienlaiðkio. Jei ið naujø elementø skaièius yra maþesnis nei ði vertë, naujienlaiðkio praneðimas nebus siunèiamas.";
$MESS["SENDER_CHAIN_ID_TIP"] = "Planuojamo siøsti naujienlaiðkio ID, kurio siuntimo data bus naudojama kaip atskaitos data naujø elementø paieðkai. Ði vertë paprastai yra paliekama kaip numatytoji.";
?>
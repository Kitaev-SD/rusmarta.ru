...
<form action="<?=$this->__component->__path?>/script.php" id="boc_<?=$arParams['ELEMENT_AREA_ID']?>_form" enctype="multipart/form-data">
	...
	<?}?>
	<div class="submit">
		<button type="button" id="boc_<?=$arParams['ELEMENT_AREA_ID']?>_btn" onclick="ym(22745254,'reachGoal','boc_posted'); ga('send', 'event', 'byoneclick', 'posted');" class="btn_buy popdef"><?=Loc::getMessage("FORMS_1CB_SEND")?></button>
	</div>
</form>

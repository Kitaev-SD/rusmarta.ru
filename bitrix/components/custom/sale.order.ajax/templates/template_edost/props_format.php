...
//echo '<br><b>arProperties:</b> <pre style="font-size: 12px">'.print_r($arProperties, true).'</pre>';
						...
						elseif ($arProperties["TYPE"] == "TEXT")
						{
							...
							<div class="bx_block r3x1"><input class = "profile_data <?=$arProperties["FIELD_NAME"]?>" type="text"  maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>"></div>

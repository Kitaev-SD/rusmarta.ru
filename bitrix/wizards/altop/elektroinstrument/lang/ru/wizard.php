<?
$MESS["WIZ_TEMPLATE_NAME"] = "Flat шаблон";
...
$MESS["WIZ_SITE_NAME_DEF"] = "Интернет-магазин электроинструмента ЭЛЕКТРОСИЛА";
...
$MESS["WIZ_SHOP_PRICE_BASE_TEXT1"] = "В решении \"Интернет-магазин электроинструмента ЭЛЕКТРОСИЛА\" используется в качестве публичных цен для просмотра и покупки базовая цена (BASE). В текущий момент для группы \"Все пользователи (в том числе неавторизованные)\" включено право на данный тип цены. Таким образом данная группа будет видеть цены в решении.";
